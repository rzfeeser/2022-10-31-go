    ...
    func main() {
        ...
        // that does not exist
        // it will simply provide the "zero value" of that type
        fmt.Println(m["skeleton"]) // there is no key named "skeleton" within our map!
        
        
        // that result doesn't tell us if "skeleton" didn't exist, OR, if the value stored with "skeleton" is a zero-value (blank line)
